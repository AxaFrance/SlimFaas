...
**@axa-fr/slimfass-planet-saver** is here to for doing that easily.
...
```javascript
npm install @axa-fr/slimfass-planet-saver
```
...
cd slimfaas/src/SlimFassPlanetSaver
npm i
npm run dev
```
